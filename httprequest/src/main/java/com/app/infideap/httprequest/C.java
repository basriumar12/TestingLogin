...
public class C<T> {
    ...
    public void setCallback(final FutureCallback<T> callback) {
        //buat async untuk mengambil respon
    ...
    private Call prepare() {
        Log.e(TAG, a.getUrl() + ": " + a.getRequestBody());
//        Log.d(TAG, "GET");
        Log.d(TAG, a.getUrl());
        RequestBody requestBody = RequestBody.create(A.JSON,
                a.getRequestBody() == null ? "" : a.getRequestBody().toString());
        if (a.getParts() != null) {
