...
public class A {
    ...
    private TimeUnit writeTimeUnit= TimeUnit.MINUTES;


    static OkHttpClient globalClient;
    OkHttpClient client;

    //inisialisasi objek OkHttpClient
    static {
...
//        builder.excludeFieldsWithoutExposeAnnotation();
    ...
    public A setWriteTimeout(long timeout, TimeUnit unit) {
